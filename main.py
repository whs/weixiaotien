...
def main():
    ...
    for model in [
        ...
        # {"model": "openai/gpt-oss-120b", **openrouter_args},
        # {"model": "openai/gpt-5-mini", **openrouter_args},
        # {"model": "openai/gpt-5-chat", **openrouter_args},
        # {"model": "openai/gpt-5-nano", **openrouter_args},
        # {"model": "google/gemini-2.5-flash-lite", **openrouter_args},
        ...
        # {"model": "anthropic/claude-opus-4.1", **openrouter_args},
        ...
        # {"model": "qwen/qwen3-235b-a22b-thinking-2507", **openrouter_args},
        # {"model": "x-ai/grok-4", **openrouter_args},
        # {"model": "moonshotai/kimi-k2", **openrouter_args},
        {"model": "deepseek/deepseek-r1-0528", **openrouter_args},
        {"model": "inception/mercury", **openrouter_args},
        {"model": "mistralai/mistral-medium-3", **openrouter_args},

        # Ollama
        # {"model": "gemma3:27b", **ollama_args},
        # {"model": "gemma3:12b", **ollama_args},
        # {"model": "gpt-oss:20b", **ollama_args},
